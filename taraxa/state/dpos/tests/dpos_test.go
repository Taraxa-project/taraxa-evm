...
func TestRegisterValidator(t *testing.T) {
	...
	test.ExecuteAndCheck(addr(1), 10, test.pack("registerValidator", uint16(10), "test", "test"), dpos.ErrExistentValidator, util.ErrorString(""))
...
func TestDelegate(t *testing.T) {
	...
	test.ExecuteAndCheck(addr(1), 10, test.pack("delegate", addr(2)), dpos.ErrNonExistentValidator, util.ErrorString(""))
	// OK
...
func TestRedelegate(t *testing.T) {
	...
	test.ExecuteAndCheck(addr(1), 0, test.pack("reDelegate", addr(1), addr(2), new(big.Int).SetUint64(10)), dpos.ErrNonExistentValidator, util.ErrorString(""))
	test.ExecuteAndCheck(addr(1), 10, test.pack("registerValidator", uint16(10), "test", "test"), util.ErrorString(""), util.ErrorString(""))
	// Validator to does not exist
	test.ExecuteAndCheck(addr(1), 0, test.pack("reDelegate", addr(1), addr(3), new(big.Int).SetUint64(10)), dpos.ErrNonExistentValidator, util.ErrorString(""))
	// Validator from does not exist
	test.ExecuteAndCheck(addr(1), 0, test.pack("reDelegate", addr(3), addr(1), new(big.Int).SetUint64(10)), dpos.ErrNonExistentValidator, util.ErrorString(""))
	// Non existen delegation
	test.ExecuteAndCheck(addr(3), 0, test.pack("reDelegate", addr(1), addr(2), new(big.Int).SetUint64(10)), dpos.ErrNonExistentDelegation, util.ErrorString(""))
	// InsufficientDelegation
	test.ExecuteAndCheck(addr(1), 0, test.pack("reDelegate", addr(1), addr(2), new(big.Int).SetUint64(11)), dpos.ErrInsufficientDelegation, util.ErrorString(""))
	// OK
...
func TestUndelegate(t *testing.T) {
	...
	test.ExecuteAndCheck(addr(2), 0, test.pack("undelegate", addr(1), new(big.Int).SetUint64(10)), dpos.ErrNonExistentValidator, util.ErrorString(""))
	test.ExecuteAndCheck(addr(1), 10, test.pack("registerValidator", uint16(10), "test", "test"), util.ErrorString(""), util.ErrorString(""))
	//Check from same undelegate request
	test.ExecuteAndCheck(addr(1), 0, test.pack("undelegate", addr(1), new(big.Int).SetUint64(10)), dpos.ErrExistentUndelegation, util.ErrorString(""))
	...
	// NonExistentValidator as it was deleted
	test.ExecuteAndCheck(addr(2), 0, test.pack("undelegate", addr(2), new(big.Int).SetUint64(10)), dpos.ErrNonExistentValidator, util.ErrorString(""))
	// NonExistentDelegation
	test.ExecuteAndCheck(addr(2), 0, test.pack("undelegate", addr(1), new(big.Int).SetUint64(10)), dpos.ErrNonExistentDelegation, util.ErrorString(""))
	// ErrInsufficientDelegation
	test.ExecuteAndCheck(addr(2), 10, test.pack("delegate", addr(1)), util.ErrorString(""), util.ErrorString(""))
	test.ExecuteAndCheck(addr(2), 0, test.pack("undelegate", addr(1), new(big.Int).SetUint64(11)), dpos.ErrInsufficientDelegation, util.ErrorString(""))
}
...
func TestCommissionRewards(t *testing.T) {
	...
	test.AddRewards(map[common.Address]*big.Int{addr(1): new(big.Int).SetUint64(10)})
	// ErrNonExistentDelegation
	test.ExecuteAndCheck(addr(2), 0, test.pack("claimCommissionRewards"), dpos.ErrNonExistentValidator, util.ErrorString(""))
	old_balance := test.GetBalance(addr(1))
