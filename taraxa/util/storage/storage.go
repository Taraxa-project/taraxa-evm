...
func (self *StorageReaderWrapper) Init(ca *common.Address, backend StorageReader) *StorageReaderWrapper {
...
func (self *StorageWrapper) Init(ca *common.Address, storage Storage) *StorageWrapper {
	self.StorageReaderWrapper.Init(ca, storage)
